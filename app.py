...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thị Vân - Trường Tiểu học Hùng An- ĐT: 091 2165 778</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thị Vân- Trường Tiểu học Hùng An- ĐT: 091 2165 778</div>", unsafe_allow_html=True)
